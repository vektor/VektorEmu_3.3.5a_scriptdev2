...
('-1999791','Aye, I wll try it.',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0','0','0','0','Hemet Nesingwary - Taste Test (1)'),
('-1999790','That is exactly what I needed!',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0','0','0','0','Hemet Nesingwary - Taste Test (2)'),
('-1999789','It is got my vote! That wll put hair on your chest like nothing else will.',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0','0','0','0','Hemet Nesingwary - Taste Test (3)'),
('-1999788','I am always up for something of Grimbooze.',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0','0','0','0','Hadrius Harlowe - Taste Test (1)'),
...
('-1999786','Now, there is the kick I\'ve come to expect from Grimbooze\'s drinks! I like it!',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0','0','0','0','Hadrius Harlowe - Taste Test (3)'),
...
('-1999783','Tastes like I am drinking... engine degreaser!',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0','0','0','0','Tamara Wobblesprocket - Taste Test (3)');
...
(-1999798,'Pressuer is too high! Open the pressure valve!',0,'SAY_OPEN_VALVE'),
(-1999799,'That will do. Never know what it will need next ...',0,'SAY_GOOD_JOB_3'),
(-1999800,'Nicely handled! Stay on your toes',0,'SAY_GOOD_JOB_4'),
(-1999801,'We have done it! Come get the cask',0,'SAY_EVENT_END'),
...
INSERT INTO script_texts (`entry`,`content_default`,`type`,`comment`) VALUES
(-1999818,'Keep quiet, will you? If anyone catches on, we are both dead.',4,'Olga (0)'),
(-1999817,'All right, fellas! Who ordered the spiced rum? Was it you, Jackie boy?',0,'Olga (1)'),
(-1999816,'Sure thing, love. Put it on Harry his tab, will you? He owes me a drink!',0,'Jack Adams (2)'),
(-1999815,'It is ok sweetheart. This one is on the house',0,'Olga (3)'),
(-1999814,'Free rum? Why... that is me favourite kind!',0,'Jack Adams (4)'),
...
(-1999820,'I am so tired. Just let me rest for a moment.',0,0,0,0,'hero spirit SAY_BLESS_2'),
(-1999821,'I can not hear the screams anymore. Is this the end?',0,0,0,0,'hero spirit SAY_BLESS_3'),
