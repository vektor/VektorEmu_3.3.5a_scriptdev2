...
UPDATE `gameobject_template` SET `castBarCaption` = 'Valroth Remains' WHERE `entry` = 191092; 

UPDATE `creature_template` SET `equipment_id` = 0 WHERE `entry` = 28912; 
UPDATE `creature_template` SET `equipment_id` = 488 WHERE `entry` = 28447;

DELETE FROM `creature_equip_template` WHERE (`entry`=488);
INSERT INTO `creature_equip_template` (`entry`, `equipentry1`, `equipentry2`, `equipentry3`) VALUES (488, 38633, 0, 0);
...
DELETE FROM `creature_template_addon` WHERE (`entry`=28447); 
...
-- -----------------------------------------
-- Quest Fix Noth Special Brew (12716/12717)
-- -----------------------------------------
