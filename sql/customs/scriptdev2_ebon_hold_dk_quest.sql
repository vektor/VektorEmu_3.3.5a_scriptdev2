...
-- After the fight
   ...
   (-1609229, 'Your master knows what lies beneath the chapel. It is why he dares not show his face! He is sent you and your death knights to meet their doom, Darion.',14587,0,0,25,'Highlord Tirion Fordring'),
   ...
   (-1609239, 'Darion Mograine, you are barely of age to hold a sword, let alone battle the undead hordes of Lordaeron! I could not bear losing you. Even the thought...',14495,0,0,1,'Highlord Alexandros Mograine'),
   ...
   (-1609244, 'You have have betrayed me! You betrayed us all you monster! Face the might of Mograine!',14707,1,0,0,'Highlord Darion Mograine'),
   (-1609245, 'He is mine now...',14805,0,0,0,'The Lich King'),
   (-1609246, 'Pathetic...',14804,0,0,0,'The Lich King'),
   (-1609247, 'You are a damned monster, Arthas!',14589,0,0,25,'Highlord Tirion Fordring'),
   ...
   (-1609249, 'How simple it was to draw the great Tirion Fordring out of hiding. You have left yourself exposed, paladin. Nothing will save you...',14807,0,0,1,'The Lich King'),
   ...
   (-1609258, 'This... is nott... over...',14811,1,0,25,'The Lich King'),
   (-1609259, 'When next we meet it was not be on holy ground, paladin.',14812,1,0,1,'The Lich King'),
...
-- Emotes
   (-1609269, 'Thousands of Scourge rise up at the Highlord is command.',0,2,0,0,''),
   (-1609270, 'The army marches towards Light is Hope Chapel.',0,2,0,0,''),
...
INSERT INTO `script_texts` (`entry`,`content_default`,`sound`,`type`,`language`,`emote`,`comment`) VALUES
   (-1609101, 'I will tear the secrets from your soul! Tell me about the "Crimson Dawn" and your life may be spared!',0,0,0,0,'player SAY_PERSUADE1'),
   (-1609102, 'Tell me what you know about "Crimson Dawn" or the beatings will continue!',0,0,0,0,'player SAY_PERSUADE2'),
   (-1609103, 'I am through being courteous with your kind, human! What is the "Crimson Dawn?"',0,0,0,0,'player SAY_PERSUADE3'),
   (-1609104, 'Is your life worth so little? Just tell me what I need to know about "Crimson Dawn" and I will end your suffering quickly.',0,0,0,0,'player SAY_PERSUADE4'),
   ...
   (-1609108, 'You will be hanging in the gallows shortly, Scourge fiend!',0,0,0,0,'crusader SAY_CRUSADER1'),
   (-1609109, 'You will have to kill me, monster! I will tell you NOTHING!',0,0,0,0,'crusader SAY_CRUSADER2'),
   ...
   (-1609114, 'I will tell you everything! STOP! PLEASE!',0,0,0,20,'break crusader SAY_PERSUADED1'),
   ...
   (-1609117, 'I know very little else... The High General chooses who may go and who must stay behind. There is nothing else... You must believe me!',0,0,0,20,'break crusader SAY_PERSUADED4'),
