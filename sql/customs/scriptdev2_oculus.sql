 ...
 */
 ...
 /* Thanks to Lanc for his work (originally form TC ) */
...
(-1578016,'Everything I haveve done... has been for Azeroth...','Все что я делал... было во имя Азерота...',13644,1,0,0,'SAY_DEATH'),
(-1578017,'A taste... just a small taste... of the Spell-Weaver is power!','Тень... лиш бледная тень... подленного могущества Хранителя магии!',13639,1,0,0,'SAY_EXPLOSION_1'),
...
(-1578021,'Still you fight. Still you cling to misguided principles. If you survive, you will find me in the center ring.','Вы все еще сражаетесь. Все еще цепляетесь за свои ложные убеждения. Если выживите, встретимся в центральном кругу.',13637,1,0,0,'SAY_SUMMON_3'),
...
(-1578031,'It is a long way down...','Как больно падать...',13628,1,0,0,'SAY_KILL_1'),
