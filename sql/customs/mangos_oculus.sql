...
(27657,0,0,'What is can Emerald Drake?.',1,1,13259,0,0,0,0,NULL,0,0,0,0,0,0,0,0,0),
...
(27659,0,0,'What is can Bronze Drake?.',1,1,13255,0,0,0,0,NULL,0,0,0,0,0,0,0,0,0),
...
(27658,0,0,'What is can Ruby Drake?.',1,1,13257,0,0,0,0,NULL,0,0,0,0,0,0,0,0,0),
...
(27657, 0, 'What is can Emerald Drake?', NULL, NULL, NULL, NULL, NULL, NULL, 'Что умеет Изумрудный дракон?', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(27659, 0, 'What is can Bronze Drake?', NULL, NULL, NULL, NULL, NULL, NULL, 'Что умеет Бронзовый дракон?', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(27658, 0, 'What is can Red Drake?', NULL, NULL, NULL, NULL, NULL, NULL, 'Что умеет Красный дракон?', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
UPDATE `creature_template` SET `mechanic_immune_mask` = 617299931 WHERE `entry` = 27447;
UPDATE `creature_template` SET `mechanic_immune_mask` = 617299931 WHERE `entry` = 31559;
UPDATE `creature_template` SET `maxhealth` = 431392 WHERE `entry` = 31558; 
UPDATE `creature_template` SET `mechanic_immune_mask` = 617299931 WHERE `entry` = 27654; 
UPDATE `creature_template` SET `mechanic_immune_mask` = 617299931 WHERE `entry` = 31558;