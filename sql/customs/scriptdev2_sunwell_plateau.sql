...
INSERT INTO `script_texts` (`entry`,`content_default`,`sound`,`type`,`language`,`emote`,`comment`) VALUES
   ...
   (-1580084, 'But I am... lost... I cannot find my way back!',12512,1,0,0,'Kil jaeden(Kalecgos) SAY_ANVEENA_LOST'),
...
-- Kiljaeden ending
   (-1580095,'Mortal heroes - your victory here today was foretold long ago. My brother is anguished cry of defeat will echo across the universe - bringing renewed hope to all those who still stand against the Burning Crusade.',12515,1,0,0,'velen_outro1'),
   (-1580096,'As the Legion is final defeat draws ever-nearer, stand proud in the knowledge that you have saved worlds without number from the flame.',12516,1,0,0,'velen_outro2'),
...
INSERT INTO `script_texts` (`entry`,`content_default`,`sound`,`type`,`language`,`emote`,`comment`) VALUES
   ...
   (-1580101,'Than fortunate it is, that I have reclaimed the noble naaru is spark from where it fell! Where faith dwells, hope is never lost, young blood elf.',12519,1,0,0,'velen_outro6'),
